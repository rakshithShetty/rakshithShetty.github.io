...
export const mainPage = {
	...
	introtext: ['I am 4th year PhD student at the ',
        ...
        ' and ',
        <a href="https://scalable.mpi-inf.mpg.de/"> Prof. Dr. Mario Fritz </a>,
        '. My primary research interest is working towards building robust computer vision models. In my recent works, I have been exploring the viability of image manipulation for quantifying and improving model robustness. I also have an interest in vision and language, with works on image captioning, visual question answering and text style transfer.'],
};
